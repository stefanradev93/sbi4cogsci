...
- 12:00 **Bayesian inference** (Turner) — Reading: Rouder & Province (2019) · [slides, first half](tutorials/day1_inference/SBI_summerschool.pptx) · [R scripts](https://github.com/stefanradev93/sbi4cogsci/tree/main/tutorials/day1_inference)
- 13:00 Lunch
...
- 09:00 **Bayes' rule, parameter estimation, model comparison** (Turner) — Reading: Turner & Van Zandt (2012) · [slides, second half](tutorials/day1_inference/SBI_summerschool.pptx) · [R scripts](https://github.com/stefanradev93/sbi4cogsci/tree/main/tutorials/day1_inference)
